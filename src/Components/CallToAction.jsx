...
const CallToAction = () => {
  ...
  return (
    <div>
      <div className="w-[70%]  h-[2px] "></div>
      <>
        <section className="py-20 lg:py-[120px] bg-slate-200 bg-gray-100/50 font-poppins">
          <div className="container mx-auto">
            <div className="bg-blue-300 relative z-10 sm:-mt-10 sm:-mb-10 overflow-x-hidden rounded py-12 px-8 md:p-[70px]">
                  ...
                  <div className="flex sm:flex-wrap sm:justify-end">
                    ...
                    >
                      ...
                      <Link to="/contact">
                        <button
                          href="#"
                          className="bg-blue-600 hover:bg-red-600 my-1 mr-4 inline-block rounded   py-4 px-6 text-base font-medium text-white transition hover:bg-opacity-100 md:px-9 lg:px-6 xl:px-9"
                        >
                          Get Started
                        </button>
                      </Link>
