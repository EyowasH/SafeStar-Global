  ...
  return (
    <div className="w-full pb-10 bg-[#f9f9f9]">
      <div className="max-w-[1240px] mx-auto">
        <div
          className=" flex lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 ss:grid-cols-1
        ...
        >
          <div className="col-span-2 ">
            ...
            />
            <h1 className="font-bold text-2xl my-1 pt-5">Hello</h1>
            <div className="pt-5">
          ...
          {/* <div className="items-center w-full bg-white rounded-xl drop-shadow-md py-5 max-h-[250px]">
            <div>
              ...
              <p className="text-center text-gray-900 font-medium">
                ...
                porro accusamus, dolorem aspernatur praesentium vitae, assumenda
                iste corporis, nesciunt error asperiores quos labore sint
                laboriosam ab quam voluptatem cupiditate id. Rem esse atque
