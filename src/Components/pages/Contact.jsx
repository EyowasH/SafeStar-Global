            ...
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0 pl-4">
                  <span className="text-red-600 mb-4 block text-base font-semibold">
                    Contact Us
                  </span>
                  <h2 className="text-red-700 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                    GET IN TOUCH WITH
                  </h2>
                  <p className="text-gray-700 mb-9 text-base leading-relaxed">
                    We are a team of experienced and qualified business
                    professionals committed to making your business our
                    business!
                  </p>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      <h4 className="text-red-600 mb-1 text-xl font-bold">
                        Our Location
                      </h4>
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <span className="text-red-600 mb-1 text-xl font-bold">Email </span> : info@yatindustrial.com
                        ...
                        <br />
                        <span className="text-red-600 mb-1 text-xl font-bold">WhatsApp</span> : +251 911 23 85 03
                        <br />
                       <span className="text-red-600 mb-1 text-xl font-bold"> WeChat</span> : +251 970 00 00 01
                      </p>
                    </div>
                  </div>
                </div>
